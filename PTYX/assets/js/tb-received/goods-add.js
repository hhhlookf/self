;(function() {
    ...
    function GoodsAddCtrlFn($scope, requestApi) {
        ...
        var orderId = localStorage.tbreceivedId ? JSON.parse(localStorage.tbreceivedId) : requestApi.dataErrorhandle();
        var itemList = localStorage.tbItemList ? JSON.parse(localStorage.tbItemList) : null;
